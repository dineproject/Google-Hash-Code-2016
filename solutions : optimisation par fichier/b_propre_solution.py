...
def get_closest_drone(drones, warehouse):
    ...
    eligible_drones = [drone for drone in drones if drone.current_turn < math.ceil((simulation.turns*(0.4627)))]
...
def process_orders(simulation, orders, delivery_plan):
    ...
    if orders:
        ...
        if order.is_completed:
            ...
            write_output_file('b_busy_day.txt', delivery_plan)
            ...
            # reprendre le traitemena_propre_solution.pyt de la commande en cours
