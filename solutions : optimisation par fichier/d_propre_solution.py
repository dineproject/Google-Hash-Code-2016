...
def get_closest_drone(drones, warehouse):
    ...
    eligible_drones = [drone for drone in drones if drone.current_turn < math.ceil((simulation.turns*(0.2147)))]
...
def process_orders(simulation, orders, delivery_plan):
    ...
    if orders:
        ...
        if order.is_completed:
            ...
            write_output_file('d_mother_of_all_warehouses.txt', delivery_plan)
